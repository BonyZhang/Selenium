...
public class Demo {
	...
	public boolean oppo_com01(WebDriver driver)
	{
		...
		flag&=elementtool.toTitle(driver,"手机助手","OPPO手机助手—OPPO官方最安全的助手");driver.close();	
		flag&=elementtool.toTitle(driver,"云服务","OPPO云服务登录");driver.close();
		flag&=elementtool.toTitle(driver,"ColorOS","ColorOS官方网站");driver.close();
		flag&=elementtool.toTitle(driver,"社区","『OPPO官方社区』OPPO手机社区_OPPO手机官方交流平台-OPPO社区官网");driver.close();
		elementtool.toTitle(driver,"官网","『OPPO手机官网』OPPO智能手机_OPPO最新款手机-OPPO智能手机官方网站");
	...
	public boolean oppo_com04_03(WebDriver driver)throws Exception 
	{
		Actions action = new Actions(driver);
		ElementTool elementtool=new ElementTool();
		boolean flag=true;
	...
	public boolean oppo_com04_04(WebDriver driver)
	{
		...
		flag&=elementtool.toTitle(driver,"OPPO积分商城","OPPO积分商城");driver.close();	
		elementtool.toTitle(driver,"官网","『OPPO手机官网』OPPO智能手机_OPPO最新款手机-OPPO智能手机官方网站");
		System.out.println("Title判断完成");
		return flag;
	}
